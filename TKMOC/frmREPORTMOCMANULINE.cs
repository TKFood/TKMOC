...
namespace TKMOC
{
    public partial class frmREPORTMOCMANULINE : Form
    {
        ...
        public StringBuilder SETSQL4(string MANU, string SDAY, string EDAY)
        {
            ...
            SB.AppendFormat(@"  ,[MOCMANULINERESULT].[MOCTA001]+[MOCMANULINERESULT].[MOCTA002] AS 'MOCTA001002'");
            SB.AppendFormat(@"  ,(SELECT ISNULL(SUM(TG011),0) FROM  [TK].dbo.[MOCTG] WHERE TG014=[MOCMANULINERESULT].[MOCTA001] AND TG015=[MOCMANULINERESULT].[MOCTA002]) AS '入庫量'");
