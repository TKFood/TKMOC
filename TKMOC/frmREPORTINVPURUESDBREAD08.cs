...
namespace TKMOC
{
    public partial class frmREPORTINVPURUESDBREAD08 : Form
    {
        ...
        public frmREPORTINVPURUESDBREAD08()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                sbSql.AppendFormat(@"  
                                   SELECT TB003 AS '品號',TB012  AS '品名',SUM(TB004)  AS '需領用量'
                                    ,(SELECT ISNULL(SUM(LA005*LA011),0) FROM [TK].dbo.INVLA WHERE LA009 IN ('21003')  AND  LA001=TB003 ) AS '烘焙倉庫存'
                                    ,((SELECT ISNULL(SUM(LA005*LA011),0) FROM [TK].dbo.INVLA WHERE LA009 IN ('21003')  AND  LA001=TB003 )-SUM(TB004)) AS '差異量'
