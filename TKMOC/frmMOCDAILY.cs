    ...
    public partial class frmMOCDAILY : Form
    {
        ...
        public StringBuilder SETSQL1()
        {
            ...
            SB.AppendFormat(@" SELECT 
                                ...
                                , ((SELECT ISNULL(SUM(TB005), 0) FROM[TK].dbo.MOCTB TB WHERE (TB.TB003 LIKE '1%' OR TB.TB003 LIKE '3%') AND TB007 IN ('kg','KG','Kg','kG') AND TB.TB001 = MOCTA.TA001 AND TB.TB002 = MOCTA.TA002)+(SELECT ISNULL(SUM(TB005*MB.UDF07/1000), 0) FROM[TK].dbo.MOCTB TB,[TK].dbo.INVMB MB WHERE MB.MB001=TB.TB003 AND (TB.TB003 LIKE '3%' AND TB007 NOT IN ('kg','KG','Kg','kG')) AND TB.TB001 = MOCTA.TA001 AND TB.TB002 = MOCTA.TA002))  AS '原料用量'
