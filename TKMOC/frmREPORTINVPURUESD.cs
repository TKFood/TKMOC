        ...
        public void SEARCHINVPURMOC(string MD003,string SDay,string EDay)
        {
            try
            {
                ...
                sbSql.AppendFormat(@"   
                                    ...
                                    ,(CASE WHEN ISNULL(MOCTB1.TB003,'')<>'' AND ISNULL((MOCTB1.TB004 - MOCTB1.TB005), 0)<=0 THEN 0 WHEN ISNULL(MOCTB2.TB003,'')<>'' AND ISNULL(MOCTB2.TB004-MOCTB2.TB005, 0)<=0 THEN 0 WHEN ISNULL(MOCTB2.TB003,'')<>'' AND ISNULL(MOCTB2.TB004-MOCTB2.TB005, 0)>0 THEN CONVERT(decimal(16,3),(ISNULL(MOCTB2.TB004-MOCTB2.TB005, 0)/ISNULL((SELECT COUNT(NO) FROM [TKMOC].[dbo].[MOCMANULINEMERGE]  WHERE [MOCMANULINEMERGE].NO=MOCTA.TA033),1))*-1) ELSE (CONVERT(decimal(16,3),([PACKAGE]/[MC004]*[MD006]/[MD007]*(1+[MD008])))*-1 ) END) AS TNUM
