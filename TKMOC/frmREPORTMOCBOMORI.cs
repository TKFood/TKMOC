...
namespace TKMOC
{
    public partial class frmREPORTMOCBOMORI : Form
    {
        ...
        public StringBuilder SETSQL()
        {
            ...
            SB.AppendFormat(@"
                               SELECT [ID]
                                ...
                                WHERE [MD003] NOT  IN (SELECT [MB001]  FROM [TKMOC].[dbo].[LIMITSREPORTMOCBOMORI])   
        ...
        public void ADDTOREPORTMOCBOM(string TA001, string TA002, string BUCKETS)
        {
            ...
            try
            {
                ...
                sbSql.AppendFormat(@" DELETE [TKMOC].[dbo].[REPORTMOCBOMORI]");
                sbSql.AppendFormat(@" ");
