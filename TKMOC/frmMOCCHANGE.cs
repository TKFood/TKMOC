        ...
        public void UPDATEMOCTB2(string TB001, string TB002)
        {
            try
            {
                ...
                sbSql.AppendFormat(@" 
                                    ...
                                    WHERE ((TB003 LIKE '201001%') OR (TB003 LIKE '202003%') OR (TB003 LIKE '202005%') OR (TB003 LIKE '202006%') OR (TB003 LIKE '210071%') OR (TB003 LIKE '205031%') OR (TB003 LIKE '205032%') OR (TB003 LIKE '203022%')  )
